...
class Splitted_AlexNet(object):
    ...
    def __init__(self, x, keep_prob, num_classes, num_channels, skip_layer, weights_path = 'DEFAULT'):
    ...
    def create(self):
        ...
        fc6 = fc(flattened, 6*6*256, 1024, name = 'fc6')
...
##########################################################
"""
end of defining class Splitted_AlexNet
